...
export default function OwnerLoginPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-amber-50 to-amber-100 text-slate-900">
      <div className="pointer-events-none absolute -left-24 top-10 h-64 w-64 rounded-full bg-amber-200/50 blur-3xl" />
      <div className="pointer-events-none absolute -right-20 bottom-0 h-72 w-72 rounded-full bg-amber-200/60 blur-3xl" />
      ...
      <main className="relative mx-auto flex min-h-screen w-full max-w-xl flex-col justify-center px-6 py-16 sm:px-10">
        ...
        <p className="mt-4 font-['Golos_Text',system-ui] text-sm text-slate-600 sm:text-base">
          Use your owner account to access dashboards and operations.
        </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  placeholder="owner@aquaorder.com"
                  required
                />
              </div>
              <div>
              ...
              <button
                ...
                className="flex w-full items-center justify-center rounded-full bg-amber-600 px-6 py-3 text-sm font-semibold text-white transition hover:bg-amber-700 disabled:cursor-not-allowed disabled:bg-slate-400"
              >
